...
class PelangganLogin extends StatefulWidget {
  ...
  @override
  State<PelangganLogin> createState() => _PelangganLoginState();
}

class _PelangganLoginState extends State<PelangganLogin> {
  final _formKey = GlobalKey<FormState>();
  final TextEditingController emailPelangganController =
      TextEditingController();
  final TextEditingController passwordPelangganController =
      TextEditingController();
  bool _isVisibility = false;
  bool _isRememberMe = false;
  bool emailPelangganError = false;
  bool passwordPelangganError = false;
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: RadialGradient(
            ...
            radius: 1.3,
            colors: [Color(0xff32B2B2), Colors.white],
          ),
        ),
        child: SafeArea(
          child: Padding(
                        ...
                        child: Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TextFormField(
                                controller: emailPelangganController,
                              ...
                              TextFormField(
                                controller: passwordPelangganController,
