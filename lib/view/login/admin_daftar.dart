...
class _AdminDaftarState extends State<AdminDaftar> {
  ...
  final TextEditingController emailAdminDaftarController =
      TextEditingController();
  final TextEditingController passwordAdminDaftar1Controller =
      TextEditingController();
  final TextEditingController passwordAdminDaftar2Controller =
      TextEditingController();
  final TextEditingController namaDepanAdminDaftarController =
      TextEditingController();
  final TextEditingController namaBelakangAdminDaftarController =
      TextEditingController();
  bool _checkboxError = false;
  bool namaDepanAdminError = false;
  bool namaBelakangAdminError = false;
  bool alamatEmailAdminError = false;
  bool password1AdminError = false;
  bool password2AdminError = false;
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          namaDepanAdminDaftarController,
                                      textAlignVertical:
                                  ...
                                  SizedBox(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          namaBelakangAdminDaftarController,
                                      textAlignVertical:
                                          TextAlignVertical.center,
                                      style: const TextStyle(
                                        color: Colors.black,
                                  ...
                                  SizedBox(
                                    width: 300,
                                    child: TextFormField(
                                      controller: emailAdminDaftarController,
                                      textAlignVertical:
                                          TextAlignVertical.center,
                                      style: const TextStyle(
                                        color: Colors.black,
                                  ...
                                  SizedBox(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          passwordAdminDaftar2Controller,
